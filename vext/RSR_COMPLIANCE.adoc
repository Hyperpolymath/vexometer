...
*Palimpsest Dual Licensing*: - MPL-2.0 - Clear SPDX identifier:
`+SPDX-License-Identifier: CC-BY-SA-4.0+` - Comprehensive LICENSE file
explaining both options - Guidance on when to choose each license -
