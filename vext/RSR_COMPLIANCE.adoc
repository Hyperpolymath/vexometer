...
|3 |Dual licensing: MPL-2.0 (code) + CC-BY-SA-4.0 (docs) |✅ |`+LICENSE+`
...
*Dual Licensing*: - MPL-2.0 for code, CC-BY-SA-4.0 for documentation -
Clear per-file SPDX identifiers - LICENSE carries the full MPL-2.0 text
- Canonical licence texts in the monorepo root `+LICENSES/+` directory
